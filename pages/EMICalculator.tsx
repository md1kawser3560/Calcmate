  ...
  return (
    <div className="max-w-6xl mx-auto pb-20">
      ...
      <div className="hidden print:block mb-8 border-b pb-4">
        ...
        <p className="text-slate-500">Generated by CalcMate - {new Date().toLocaleDateString()}</p>
      </div>
          ...
          <div className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm flex flex-col items-center print:shadow-none">
            <div className="h-[280px] w-full">
              <ResponsiveContainer width="100%" height="100%">
                <PieChart>
                  <Pie data={data} cx="50%" cy="50%" innerRadius={70} outerRadius={100} paddingAngle={8} dataKey="value" stroke="none">
